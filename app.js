...
const translations = {
    uk: {
        ...
        mem_recall_ready: 'Запам\'ятав(ла)',
        mem_recall_pick_q: 'Які слова тут були?',
        mem_recall_pick_hint: 'Половина слів зайві — тисни лише ті, що бачив(ла)',
        ...
        mem_chain_done_kid: 'Історію склав(ла) 🌿',
        mem_imagery_q: 'Що вони роблять разом?',
        mem_imagery_hint: 'Не поруч, а саме разом: слон їсть ложкою, парасолька катає кавун',
        mem_imagery_done: 'Придумав(ла)',
        mem_imagery_help_btn: 'Не придумав(ла)? Приклад',
        mem_imagery_recall_q: 'З чим це було разом?',
        mem_rehearsal_q: 'Повтори всі слова вголос',
        mem_rehearsal_hint: 'Щоразу з самого початку — саме це й тренує',
        mem_rehearsal_done: 'Повторив(ла)',
        mem_rehearsal_check_q: 'Спробуй сказати всі {n} без підказки. Вийшло?',
        mem_rehearsal_check_hint: 'Слова заховані — тепер лише з пам\'яті',
    ...
    en: {
        ...
        mem_imagery_help_btn: "Can't think of one? Example",
        mem_imagery_recall_q: 'What was it together with?',
        mem_rehearsal_q: 'Say all the words out loud',
        mem_rehearsal_hint: 'From the very beginning each time — that is the exercise',
        mem_rehearsal_done: 'Repeated',
        mem_rehearsal_check_q: 'Try saying all {n} without looking. Did it work?',
        mem_rehearsal_check_hint: 'Words are hidden now — from memory only',
    ...
    pl: {
        ...
        mem_imagery_help_btn: 'Nie wiesz? Przykład',
        mem_imagery_recall_q: 'Z czym to było razem?',
        mem_rehearsal_q: 'Powtórz wszystkie słowa na głos',
        mem_rehearsal_hint: 'Za każdym razem od początku — to właśnie jest ćwiczenie',
        mem_rehearsal_done: 'Powtórzone',
        mem_rehearsal_check_q: 'Spróbuj powiedzieć wszystkie {n} bez podpowiedzi. Udało się?',
        mem_rehearsal_check_hint: 'Słowa są ukryte — teraz tylko z pamięci',
    ...
    de: {
        ...
        mem_imagery_help_btn: 'Keine Idee? Beispiel',
        mem_imagery_recall_q: 'Womit war das zusammen?',
        mem_rehearsal_q: 'Sag alle Wörter laut',
        mem_rehearsal_hint: 'Jedes Mal von ganz vorn — genau das ist die Übung',
        mem_rehearsal_done: 'Wiederholt',
        mem_rehearsal_check_q: 'Versuch alle {n} ohne Hilfe zu sagen. Hat\'s geklappt?',
        mem_rehearsal_check_hint: 'Wörter sind jetzt versteckt — nur aus dem Gedächtnis',
    ...
    fr: {
        ...
        mem_imagery_help_btn: 'Pas d\'idée ? Exemple',
        mem_imagery_recall_q: 'Avec quoi était-ce ensemble ?',
        mem_rehearsal_q: 'Dis tous les mots à voix haute',
        mem_rehearsal_hint: 'Depuis le tout début à chaque fois — c\'est ça, l\'exercice',
        mem_rehearsal_done: 'Répété',
        mem_rehearsal_check_q: 'Essaie de dire les {n} sans regarder. Ça a marché ?',
        mem_rehearsal_check_hint: 'Les mots sont cachés — de mémoire seulement',
    ...
    es: {
        ...
        mem_imagery_help_btn: '¿Sin ideas? Ejemplo',
        mem_imagery_recall_q: '¿Con qué estaba junto?',
        ...
        mem_rehearsal_done: 'Repetido',
        mem_rehearsal_check_q: 'Intenta decir las {n} sin mirar. ¿Funcionó?',
        mem_rehearsal_check_hint: 'Las palabras están ocultas — solo de memoria',
...
const MOTIVATIONS = {
    uk: {
        ...
        mind:     ["Довіряємо твоєму мозку 🧠", "Сам(а) знаєш краще 😄", "Відчув(ла) — значить запам'ятав(ла)!", "Клас! Ти сам(а) собі суддя 🎓"]
    },
    en: {
